(function () {
  ...
  (function () {
    ...
    function injectStyle() {
      ...
      style.id = STYLE_ID;
      var text = [
    'body.' + BODY_CLASS + ' .card__vote, body.' + BODY_CLASS + ' .card__vote_block, body.' + BODY_CLASS + ' .card__rating, body.' + BODY_CLASS + ' .nfx-card-overlay__rating, body.' + BODY_CLASS + ' .rating-badge, body.' + BODY_CLASS + ' .rating-label, body.' + BODY_CLASS + ' .card__subtitle, body.' + BODY_CLASS + ' .nfx-card-overlay__subtitle, body.' + BODY_CLASS + ' .card-episode__num, body.' + BODY_CLASS + ' .full-episode__num, body.' + BODY_CLASS + ' .seasons-info, body.' + BODY_CLASS + ' .episodes-info, body.' + BODY_CLASS + ' .card__genre, body.' + BODY_CLASS + ' .genre-info, body.' + BODY_CLASS + ' .card__quality, body.' + BODY_CLASS + ' .nfx-card-overlay__badge, body.' + BODY_CLASS + ' .quality-label, body.' + BODY_CLASS + ' .card__age, body.' + BODY_CLASS + ' .card__year, body.' + BODY_CLASS + ' .year-info, body.' + BODY_CLASS + ' .card__country, body.' + BODY_CLASS + ' .country-info, body.' + BODY_CLASS + ' .nfx-card-overlay__meta { display: none !important; }',
        ...
        'body.' + BODY_CLASS + ' .card-episode .full-episode__img::before { content:"" !important; position:absolute !important; inset:auto 0 0 0 !important; height:62% !important; background: transparent !important; z-index:2 !important; pointer-events:none !important; border-radius:0 0 1.35em 1.35em !important; }',
